...
parser.add_argument(
    "--restore", action="store_true", help="Equivalent to '--labels --duedate'"
)
parser.add_argument("--verbose", action="store_true", help="Print output for debugging")
parser.add_argument(
    "--duedate", action="store_true", help="Update all duedate for each card"
)
parser.add_argument(
    "--labels", action="store_true", help="Update label (todo and other) on each card"
)
...
parser.add_argument(
    "--list-cards", action="store_true", help="See all the cards in the board"
)
